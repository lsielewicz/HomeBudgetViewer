        ...
        public static List<CurrencyModel> PossibleCurrencies
        {
            get
            {
                return _possibleCurrencies ?? (_possibleCurrencies = new List<CurrencyModel>()
                {
                   ...
                   new CurrencyModel() {CurrencyEnum = Currency.Peso, CurrencyName = "Pesos", CurrencySymbol = " $  "},
                   ...
                   new CurrencyModel() {CurrencyEnum = Currency.Dolar, CurrencyName = "Zloty", CurrencySymbol = " ZŁ "},
                });
            }
        }
    }
